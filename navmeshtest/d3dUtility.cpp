...
void CenterWindow(HWND hwndWindow)
{
	...
	::MoveWindow(hwndWindow, rctomove.left, rctomove.top, rc1.right - rc1.left, rc1.bottom - rc1.top,true);
}
	...
	navmgr *nav_mgr)
{
	...
	HWND hwnd = 0;
	hwnd = ::CreateWindow(L"导航网格", L"导航网格",
		WS_EX_TOPMOST,
		0, 0, width, height,
	...
	if(nav_mgr != NULL)
	{
		nav_mgr->init_out_polygon(rect.right,rect.bottom);
	}
